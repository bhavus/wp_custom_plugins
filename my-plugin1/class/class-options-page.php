<?php
  ...
  class OptionsPage {
    ...
    public function create_settings_page(){
      add_menu_page('MNSP Settings', 'MNSP Settings', 'manage_options', 'MNSP-settings', [$this, 'render_settings_form'], '', 100);
    }
    ...
    public function handle_file_upload($file){
      ...
      if(empty($file['footer_background']['name'])){
        if(!get_option('MNSP_footer_background')){
      ...
      if($uploaded && !isset($uploaded['error'])){
        ...
        update_option('MNSP_footer_background', $attach_id);
    ...
    public function handle_settings_form(){
      if (!isset($_POST['MNSP_settings_nonce'])
      || !wp_verify_nonce($_POST['MNSP_settings_nonce'], 'MNSP_save_settings')){
        ?>
        <div class="notice notice-error">
        ...
        foreach ($required as $field) {
          update_option('MNSP_' . $field, $$field);
        }
    ...
    public function render_settings_form(){
      ...
      if(isset($_POST['MNSP_settings_form']) && $_POST['MNSP_settings_form']){
      ...
      ?>
        <div class="wrap">
          ...
          <form method="POST" enctype="multipart/form-data">
                  ...
                  <tr>
                    ...
                    <td>
                      <input 
                        ...
                        name="header_phone"
                        id="header_phone"
                        value="<?php echo get_option('MNSP_header_phone'); ?>"
                        class="regular-text"
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <input 
                        ...
                        name="header_email"
                        id="header_email"
                        value="<?php echo get_option('MNSP_header_email'); ?>"
                        class="regular-text"
                      />
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <input 
                        ...
                        name="footer_heading"
                        id="footer_heading"
                        value="<?php echo get_option('MNSP_footer_heading'); ?>"
                        class="regular-text"
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <textarea
                        ...
                        id="footer_copy"
                        class="regular-text"
                      ><?php echo get_option('MNSP_footer_copy'); ?></textarea>
                    </td>
                  </tr>
                  <tr>
                    <th>
                    ...
                    <td>
                      <input
                        ...
                        class="regular-text"
                        value="<?php echo get_option('MNSP_footer_button_text'); ?>"
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <input
                        ...
                        class="regular-text"
                        value="<?php echo get_option('MNSP_footer_button_link'); ?>"
                      />
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      ...
                      />
                      <?php
                        if(is_numeric($attach_id = get_option('MNSP_footer_background'))){
              ...
              <?php wp_nonce_field('MNSP_save_settings', 'MNSP_settings_nonce'); ?>

              <input type="hidden" name="MNSP_settings_form" value="true" />
