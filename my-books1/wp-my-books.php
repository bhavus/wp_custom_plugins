...
$slug = '';
$pages_includes = array("frontendpage","book-list","book-add","book-edit","add-author","remove-author","add-student","remove-student","course-tracker");

// $currentPage = $_GET['page'];

 // Check if 'page' key exists in $_GET array
...
function my_book_plugin_menus() {
    ...
    add_submenu_page("book-list", "Add New Book", "Add New Book", "manage_options", "book-add", "my_book_add");
