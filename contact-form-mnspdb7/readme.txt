=== Contact Form 7 Database Addon - MNSPDB7 ===
...
The "MNSPDB7" plugin saves contact form 7 submissions to your WordPress database. Export the data to a CSV file.
...
* [MNSPDB7 DB Switcher](https://ciphercoin.com/downloads/mnspdb7-database-switcher/)
Connect MNSPDB7 to an external database or another DB
...
* [Already Submitted?](https://ciphercoin.com/downloads/mnspdb7-unique-field/)
...
* [Export PDF File](https://ciphercoin.com/downloads/mnspdb7-export-pdf-addon/)
...
Extensions : [Contact form 7 more Add-ons](https://ciphercoin.com/contact-form-7-database-mnspdb7-add-ons/)
