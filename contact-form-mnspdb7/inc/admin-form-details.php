...
class Mnspdb7_Form_Details
{
    ...
    public function form_details_page(){
        ...
        $mnspdb7_dir_url = $upload_dir['baseurl'].'/mnspdb7_uploads';
        $rm_underscore = apply_filters('mnspdb7_remove_underscore_data', true); 
        ...
        ?>
        <div class="wrap">
            <div id="welcome-panel" class="mnspdb7-panel">
                <div class="mnspdb7-panel-content">
                    <div class="welcome-panel-column-container">
                        <?php do_action('mnspdb7_before_formdetails_title',$this->form_post_id ); ?>
                        <h3><?php echo get_the_title( $this->form_post_id ); ?></h3>
                        <?php do_action('mnspdb7_after_formdetails_title', $this->form_post_id ); ?>
        ...
        <?php
        do_action('mnspdb7_after_formdetails', $this->form_post_id );
    }
